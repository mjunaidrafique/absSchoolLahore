                ...
                <div class="col-lg-9 col-md-9 col-12">
                    ...
                    <div class="header-widget">
                        ...
                        <div class="single-widget">
                            ...
                            <h4>Send Message<a href="mailto:mailus@mail.com"><span>ABScadetschool@gmail.com</span></a></h4>
                        </div>
                        <div class="single-widget">
...
<section class="home-slider">
    <div class="slider-active">
        ...
        <!--/ End Single Slider -->
        <!-- Single Slider -->
        <div class="single-slider overlay" style="background-image:url('images/slider/slider-bg2.jpg')">
            <div class="container">
                <div class="row">
        ...
        <!--/ End Single Slider -->
        <!-- Single Slider -->
        <div class="single-slider overlay" style="background-image:url('images/slider/slider-bg3.jpg')">
            <div class="container">
                <div class="row">
